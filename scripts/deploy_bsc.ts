...
(async () => {
  try {
    ...
    // // taxManager set launchpad router to fRouter, so can have onlyLaunchpadRouter access
    ...
    const taxManagerAddress = "0x494491b89E56eA881B694372E08dc9514F880948";
    const taxManager = await ethers.getContractAt(
      "TaxManager",
      taxManagerAddress
    );
    const fFactoryV2Address = "0x4f8499CE763C0B621bF355c01ECA3784d8192559";
    const fFactoryV2 = await ethers.getContractAt(
      "FFactoryV2",
      fFactoryV2Address
    );
    const fRouterAddress = "0x2E711073384c0F6d87F9238289c9f4Cbd931119c";
    const fRouter = await ethers.getContractAt("FRouter", fRouterAddress);
    const launchpadV2Address = "0x6bcf35148fDDc2a254562a2684c777eF517A8235";
